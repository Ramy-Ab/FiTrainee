...
export const UserTraineeReducer = (state = { trainee: {} }, action) => {
  switch (action.type) {
    case "trainee_info":
...
export const traineeInfoReducer = (state = { personelInfo: {} }, action) => {
  switch (action.type) {
    case TRAINEE_INFO_REQUEST:
      return { loading: true };

    case TRAINEE_INFO_SUCCESS:
...
export const updateWeightReducer = (state = {}, action) => {
  switch (action.type) {
    case TRAINEE_UPDATE_WEIGHT_REQUEST:
      return { loading: true };

    case TRAINEE_UPDATE_WEIGHT_SUCCESS:
      return { loading: false, success: true };
