...
./manage.py makemigrations legacy stats system_configuration user_managments training_and_courses client_folder stock_and_inventory planing_and_reservation accounting_management funds_managments
./manage.py migrate
